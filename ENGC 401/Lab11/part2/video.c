...
{
	resolution_x = (pixel_ctrl_ptr[2]) & 0x0000FFFF; //collect the first 16 bits from resolution register
	resolution_y = (pixel_ctrl_ptr[2]) >> 16; //collect second 16 bits from resolution register
}
void clear_screen()
{
	int i,j;
